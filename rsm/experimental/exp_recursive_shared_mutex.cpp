...
bool exp_recursive_shared_mutex::end_of_exclusive_ownership()
{
    return (_shared_while_exclusive_counter == 0 && _write_counter == 0);
}

bool exp_recursive_shared_mutex::check_for_write_lock(const std::thread::id &locking_thread_id)
{
    return (_write_owner_id == locking_thread_id);
}

bool exp_recursive_shared_mutex::check_for_write_unlock(const std::thread::id &locking_thread_id)
{
...
bool exp_recursive_shared_mutex::already_has_lock_shared(const std::thread::id &locking_thread_id)
{
    return (_read_owner_ids.find(locking_thread_id) != _read_owner_ids.end());
}

void exp_recursive_shared_mutex::lock_shared_internal(const std::thread::id &locking_thread_id, const uint64_t &count)
{
...
void exp_recursive_shared_mutex::unlock_shared_internal(const std::thread::id &locking_thread_id, const uint64_t &count)
{
    auto it = _read_owner_ids.find(locking_thread_id);
    if (it == _read_owner_ids.end())
    {
...
void exp_recursive_shared_mutex::lock()
{
...
bool exp_recursive_shared_mutex::try_promotion()
{
    const std::thread::id &locking_thread_id = std::this_thread::get_id();
    std::unique_lock<std::mutex> _lock(_mutex);
...
bool exp_recursive_shared_mutex::try_lock()
{
    const std::thread::id &locking_thread_id = std::this_thread::get_id();
...
void exp_recursive_shared_mutex::unlock()
{
    const std::thread::id &locking_thread_id = std::this_thread::get_id();
...
void exp_recursive_shared_mutex::lock_shared()
{
    const std::thread::id &locking_thread_id = std::this_thread::get_id();
    std::unique_lock<std::mutex> _lock(_mutex);
...
bool exp_recursive_shared_mutex::try_lock_shared()
{
    const std::thread::id &locking_thread_id = std::this_thread::get_id();
    std::unique_lock<std::mutex> _lock(_mutex, std::try_to_lock);
    if (check_for_write_lock(locking_thread_id))
...
void exp_recursive_shared_mutex::unlock_shared()
{
    const std::thread::id &locking_thread_id = std::this_thread::get_id();
    std::lock_guard<std::mutex> _lock(_mutex);
